...
public class CleanableHistoricCaseInstanceReportDto implements Serializable {
  ...
  public static List<CleanableHistoricCaseInstanceReportDto> convert(List<CleanableHistoricCaseInstanceReportResult> reportResult) {
    List<CleanableHistoricCaseInstanceReportDto> dtos = new ArrayList<CleanableHistoricCaseInstanceReportDto>();
    for (CleanableHistoricCaseInstanceReportResult current : reportResult) {
      CleanableHistoricCaseInstanceReportDto dto = new CleanableHistoricCaseInstanceReportDto();
